...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null ){
            ...
            convertView = inflator.inflate(R.layout.todo_item,parent,false);
        }
        ...
        StringBuilder sPriority = new StringBuilder("Priority:");
        switch (priority) {
            case LOW: sPriority.append("LOW");
                break;
            case MED: sPriority.append("MED");
                break;
            case HIGH: sPriority.append("HIGH");
                break;
            default:
        }
        priorityView.setText(sPriority);
